 ...
 */
public class TopRatedFragment extends MovieTuneFragment {
    private final static String TAG = "TopRatedFragment";
    Fragment toLaunchFragment = null;
    private String url = "https://api.themoviedb.org/3/movie/top_rated?api_key=c37d3b40004717511adb2c1fbb15eda4&page=1";
    private String url2 = "https://api.themoviedb.org/3/movie/top_rated?api_key=c37d3b40004717511adb2c1fbb15eda4&page=";

    private List<NewRelease> newReleaseList;
    private int counter = 1;
    private int counterLimit = 221;
